...
class HomeFragment(
    ...
    override fun onCreateView(
        ...
        giftList.add(GiftModel("Ducati Panigale V4", "26 490€  [o_O]", "https://images.ctfassets.net/x7j9qwvpvr5s/2zYQHBj5OxbGGvtcdiv2EK/a876ddf620f84c92a362522bcdc14a90/Panigale-MY22-Studio-42-Gallery-1920x1080.jpg", true))
        ...
        giftList.add(GiftModel("Kawasaki Ninja H2R", "52 000€  ( ͡° ͜ʖ ͡°)", "https://cdn.pixabay.com/photo/2021/04/19/05/12/kawasaki-ninja-h2r-6190254_1280.jpg", false))
        giftList.add(GiftModel("One day", "They'll all be mine", "https://imgflip.com/s/meme/Smiling-Cat.jpg", true))
